 ...
 * FormResp.java
 *
 * Created on Nov 7, 2011, 6:34:48 PM
 * @author Eduardo
...
public class FormResponsavel extends javax.swing.JDialog {
    private Responsavel bean = new Responsavel();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Confirma exclusão",
                "Cadastro de Responsavel", JOptionPane.YES_OPTION,
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (acao == 'I'){ // Inclusão
            atualizaBean(false);
            if (dao.Insere(bean)){
                bean.setCodResp(dao.ultimaChave());
                jtfCodigo.setText(String.valueOf(bean.getCodResp()));
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        bean.setCodResp((Integer) tabela.getValueAt(linha, coluna++));
    ...
    */
    ...
    private void addTabela(Responsavel c){
        Vector colunas = new Vector();

        colunas.add(c.getCodResp());
        colunas.add(c.getDesc());

        linhas.add(colunas);
    }

    private void updateTabela(Responsavel c){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (c.getCodResp() == (Integer) tabela.getValueAt(i, 0)){
    ...
    private void removeTabela(Responsavel c){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (c.getCodResp() == (Integer) tabela.getValueAt(i, 0)){
                linhas.remove(i);
    ...
    private void atualizaBean(boolean codigo){
        // Atualiza os campos de edição
        if (codigo)
            bean.setCodResp(Integer.parseInt(jtfCodigo.getText()));
