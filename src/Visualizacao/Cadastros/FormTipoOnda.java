 ...
 * @author cliente
 */
public class FormTipoOnda extends javax.swing.JDialog {

    private TipoOnda bean = new TipoOnda();
    private TipoOndaDAO dao = new TipoOndaDAO();
    ...
    public FormTipoOnda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        setTitle("Cadastro de Tipos de Onda");
        if (montaTabela() == 0){
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (acao == 'I'){ // Inclusão
            atualizaBean(false);
            if (dao.Insere(bean)){
                bean.setCodTipoOnda(dao.ultimaChave());
                jtfCodigo.setText(String.valueOf(bean.getCodTipoOnda()));
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        bean.setCodTipoOnda((Integer) tabela.getValueAt(linha, coluna++));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormTipoOnda dialog = new FormTipoOnda(new javax.swing.JFrame(), true);
    ...
    private void addTabela(TipoOnda c){
    ...
    private void updateTabela(TipoOnda c){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (c.getCodTipoOnda()== (Integer) tabela.getValueAt(i, 0)){
    ...
    private void removeTabela(TipoOnda c){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (c.getCodTipoOnda()== (Integer) tabela.getValueAt(i, 0)){
                linhas.remove(i);
    ...
    private void atualizaBean(boolean codigo){
        // Atualiza os campos de edição
        if (codigo)
            bean.setCodTipoOnda(Integer.parseInt(jtfCodigo.getText()));
