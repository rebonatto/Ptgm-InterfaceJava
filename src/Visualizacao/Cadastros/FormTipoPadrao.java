 ...
 * FormTipoPadrao.java
 *
 * Created on Nov 4, 2011, 7:43:58 AM
 * @author rebonatto
 */
 ...
 * @author rebonatto
 */
public class FormTipoPadrao extends javax.swing.JDialog {

    private TipoPadrao bean = new TipoPadrao();
    private TipoPadraoDAO dao = new TipoPadraoDAO();
    private boolean editando;
    private char acao;
    Vector titulos = new Vector();
    Vector linhas  = new Vector();

    /** Creates new form FormTipoOnda */
    public FormTipoPadrao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        setTitle("Cadastro de Tipo de Padrao de Onda");
        if (montaTabela() == 0){
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Confirma exclusão",
                "Cadastro de Tipo de Padrao de Onda", JOptionPane.YES_OPTION,
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (acao == 'I'){ // Inclusão
            atualizaBean(false);
            if (dao.Insere(bean)){
                bean.setCodTipoPadrao(dao.ultimaChave());
                jtfCodigo.setText(String.valueOf(bean.getCodTipoPadrao()));
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        bean.setCodTipoPadrao((Integer) tabela.getValueAt(linha, coluna++));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormTipoPadrao dialog = new FormTipoPadrao(new javax.swing.JFrame(), true);
    ...
    private void addTabela(TipoPadrao t){
        Vector colunas = new Vector();

        colunas.add(t.getCodTipoPadrao());
        colunas.add(t.getDesc());

        linhas.add(colunas);
    }

    private void updateTabela(TipoPadrao t){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (t.getCodTipoPadrao()== (Integer) tabela.getValueAt(i, 0)){
                tabela.setValueAt(t.getDesc(), i, 1);
    ...
    private void removeTabela(TipoPadrao t){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (t.getCodTipoPadrao()== (Integer) tabela.getValueAt(i, 0)){
                linhas.remove(i);
    ...
    private void atualizaBean(boolean codigo){
        // Atualiza os campos de edição
        if (codigo)
            bean.setCodTipoPadrao(Integer.parseInt(jtfCodigo.getText()));
