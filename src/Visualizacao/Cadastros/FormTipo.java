...
public class FormTipo extends javax.swing.JDialog {

    private Tipo bean = new Tipo();
    ...
    public FormTipo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Cadastro de Tipos de Equipamentos");
        if (montaTabela() == 0){
     ...
     public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormTipo dialog = new FormTipo(new javax.swing.JFrame(), true);
    ...
    private void addTabela(Tipo c){
        Vector colunas = new Vector();

        colunas.add(c.getCodTipo());
        colunas.add(c.getDesc());

        linhas.add(colunas);
    }

    private void updateTabela(Tipo c){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (c.getCodTipo() == (Integer) tabela.getValueAt(i, 0)){
    ...
    private void removeTabela(Tipo c){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (c.getCodTipo() == (Integer) tabela.getValueAt(i, 0)){
                linhas.remove(i);
    ...
    private void atualizaCampos(){
        ...
        jtfCodigo.setText(String.valueOf(bean.getCodTipo()));
    ...
    private void atualizaBean(boolean codigo){
        // Atualiza os campos de edição
        if (codigo)
            bean.setCodTipo(Integer.parseInt(jtfCodigo.getText()));
    ...
    private void atualizaFormTabela(){
        ...
        bean.setCodTipo((Integer) tabela.getValueAt(linha, coluna++));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Confirma exclusão",
                "Cadastro de Tipos", JOptionPane.YES_OPTION,
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (acao == 'I') { // Inclusão
            atualizaBean(false);
            if (dao.Insere(bean)) {
                bean.setCodTipo(dao.ultimaChave());
                jtfCodigo.setText(String.valueOf(bean.getCodTipo()));
