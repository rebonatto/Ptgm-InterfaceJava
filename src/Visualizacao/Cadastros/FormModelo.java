 ...
 * FormModelo.java
 *
 * Created on Nov 3, 2011, 10:04:24 PM
 * @author Eduardo
...
public class FormModelo extends javax.swing.JDialog {
    ...
    private Modelo bean = new Modelo();
    ...
    private void addTabela(Modelo c){
        Vector colunas = new Vector();

        colunas.add(c.getCodModelo());
        colunas.add(c.getDesc());

        linhas.add(colunas);
    }

    private void updateTabela(Modelo c){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (c.getCodModelo() == (Integer) tabela.getValueAt(i, 0)){
    ...
    private void removeTabela(Modelo c){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (c.getCodModelo() == (Integer) tabela.getValueAt(i, 0)){
                linhas.remove(i);
    ...
    private void atualizaCampos(){
        ...
        jtfCodigo.setText(String.valueOf(bean.getCodModelo()));
    ...
    private void atualizaBean(boolean codigo){
        // Atualiza os campos de edição
        if (codigo)
            bean.setCodModelo(Integer.parseInt(jtfCodigo.getText()));
    ...
    private void atualizaFormTabela(){
        ...
        bean.setCodModelo((Integer) tabela.getValueAt(linha, coluna++));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Confirma exclusão",
                "Cadastro de Modelos", JOptionPane.YES_OPTION,
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (acao == 'I'){ // Inclusão
            atualizaBean(false);
            if (dao.Insere(bean)){
                bean.setCodModelo(dao.ultimaChave());
                jtfCodigo.setText(String.valueOf(bean.getCodModelo()));
