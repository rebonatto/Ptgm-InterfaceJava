 ...
 * FormSala.java
 *
 * Created on Nov 7, 2011, 9:40:01 PM
 * @author Eduardo
 ...
 * @author cliente
 */
public class FormSala extends javax.swing.JDialog {
    private SalaCirurgia bean = new SalaCirurgia();
    private SalaCirurgiaDAO dao = new SalaCirurgiaDAO();
    ...
    public FormSala(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        setTitle("Cadastro de Sala de Cirurgia");
        if (montaTabela() == 0){
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Confirma exclusão",
                "Cadastro de SalaCirurgia", JOptionPane.YES_OPTION,
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (acao == 'I'){ // Inclusão
            atualizaBean(false);
            if (dao.Insere(bean)){
                bean.setCodSala(dao.ultimaChave());
                jtfCodigo.setText(String.valueOf(bean.getCodSala()));
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        bean.setCodSala((Integer) tabela.getValueAt(linha, coluna++));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormSala dialog = new FormSala(new javax.swing.JFrame(), true);
    ...
    private void addTabela(SalaCirurgia c){
        Vector colunas = new Vector();

        colunas.add(c.getCodSala());
        colunas.add(c.getDesc());

        linhas.add(colunas);
    }

    private void updateTabela(SalaCirurgia c){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (c.getCodSala() == (Integer) tabela.getValueAt(i, 0)){
    ...
    private void removeTabela(SalaCirurgia c){
        for(int i=0; i < linhas.size(); i++){
            // Achou o mesmo código
            if (c.getCodSala() == (Integer) tabela.getValueAt(i, 0)){
                linhas.remove(i);
    ...
    private void atualizaBean(boolean codigo){
        // Atualiza os campos de edição
        if (codigo)
            bean.setCodSala(Integer.parseInt(jtfCodigo.getText()));
